...
```sh
git clone git@github.com:tangibleinc/tangible-plugin-playground.git
cd tangible-plugin-playground
npm install
```
...
{
  "mappings": {
    "wp-content/plugins/tangible-plugin-playground": "../tangible-plugin-playground"
  }
}
```
