...
describe('Admin', () => {
  ...
  const plugins = [
    ['Tangible Plugin Playground', 'tangible-plugin-playground/tangible-plugin-playground'],
  ]
...
describe('Plugin settings page', () => {
  test('Can be visited', async ({ admin, page }) => {
    await admin.visitAdminPage('/options-general.php?page=tangible-plugin-playground-settings')
