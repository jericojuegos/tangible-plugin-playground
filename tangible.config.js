export default {
  build: [
    ...
    //   dest: 'assets/build/tangible-plugin-playground.min.js'
    // },
    // {
    //   src: 'assets/src/index.scss',
    //   dest: 'assets/build/tangible-plugin-playground.min.css'
    // },
  ...
  archive: {
    root: 'tangible-plugin-playground',
    src: [
      '*.php',
      'assets/**',
      'includes/**',
    ...
    dest: 'publish/tangible-plugin-playground.zip',
    exclude: [
      'assets/src',
      'docs',
